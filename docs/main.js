...
/* harmony import */ var _services_task_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/task.service */ "./src/app/services/task.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_services_task_service__WEBPACK_IMPORTED_MODULE_8__["TaskService"]],
...
var APP_ROUTES = [
    ...
    { path: 'inicio', component: _components_inicio_inicio_component__WEBPACK_IMPORTED_MODULE_2__["InicioComponent"] },
...
module.exports = "\n<a [routerLink]=\"['/inicio']\" class=\"btn btn-default mr-2\">Inicio</a> \n<a [routerLink]=\"['/task']\" class=\"btn btn-default\">Tareas1</a>\n<a [routerLink]=\"['/tarea']\" class=\"btn btn-default\">Tareas2</a>"
...
var TaskComponent = /** @class */ (function () {
    ...
    TaskComponent.prototype.editarTask = function (e, task) {
        this.task = task;
        this.status = "guardar";
    };
    TaskComponent.prototype.deleteTask = function (e, task) {
...
var TaskService = /** @class */ (function () {
    ...
    TaskService.prototype.addTask = function (task) {
        ...
        if (!task.id) {
            id = this.db.createId();
            task = { id: id, "name": task.name, "category": task.category };
        }
...
var environment = {
    production: false,
    //Pegar enlace de la base de datos
    firebase: {
        apiKey: "AIzaSyCoEdXZcb2zczsEyiD2tozUOeHiwFbxMUE",
        authDomain: "mytodo-7e560.firebaseapp.com",
        databaseURL: "https://mytodo-7e560.firebaseio.com",
        projectId: "mytodo-7e560",
        storageBucket: "mytodo-7e560.appspot.com",
        messagingSenderId: "225682742060"
    }
};
/*
...
module.exports = __webpack_require__(/*! /home/administrador/WebDiplomado/todo/src/main.ts */"./src/main.ts");
